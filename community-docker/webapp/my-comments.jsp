        ...
        <div class="comment-list">
          <%
            try {
              ...
              try (Connection conn = ds.getConnection()) {
                String sql = "SELECT DISTINCT c.post_id, c.content, c.created_at, " +
                           "p.title, p.board_name " +
                           "FROM comments c " +
          ...
          <div class="comment-list-item">
            <a href="/post?id=<%= postId %>">
              <div class="comment-post-title"><%= title %></div>
